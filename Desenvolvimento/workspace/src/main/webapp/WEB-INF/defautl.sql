-- Admin
insert into Fisioterapeuta (id,login,nome,senha) values (1,"admin","admin","admin");

-- Categorias
insert into Categoria (id,descricao,status) values (1,"ocorrencia",'A');
insert into Categoria (id,descricao,status) values (2,"intercorrencia",'A');
insert into Categoria (id,descricao,status) values (3,"indice",'A');
