...
public class AtendimentoController {
	...
	public String salvar(@PathVariable Long pacienteId,ValorAtendimento valorAtendimento) {
		System.out.println(valorAtendimento.getValor() + "Valor - ID" + valorAtendimento.getVariavelId());
		...
		//SetarVariavel
		historico.setVariavel(variavelDao.get(valorAtendimento.getVariavelId()));
		//SetarValor
