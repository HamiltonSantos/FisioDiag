...
class VariablesControllerTest < ActionController::TestCase
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post :create, variable: { category_id: @variable.category_id, description: @variable.description, value: @variable.value }
    end
  ...
  test "should update variable" do
    put :update, id: @variable, variable: { category_id: @variable.category_id, description: @variable.description, value: @variable.value }
    assert_redirected_to variable_path(assigns(:variable))
  end
